...
function show_etherstate(){
	...
	if ((based_modelid == "RT-N16") || (based_modelid == "RT-AC87U")
	    ...
	    || (based_modelid == "RT-AC3100") || (productid == "R6300v2"))
		reversed = true;
	else
		reversed = false;
	...
	for (var i = 0; i < t.length; ++i) {
		...
		if (line[0] == "Port") {
			...
			if (port == "8") {		// CPU Port
				continue;
			} else if ((based_modelid == "RT-AC56U") || (based_modelid == "RT-AC56S") || (based_modelid == "RT-AC88U") || (based_modelid == "RT-AC3100") || (productid == "R6300v2")) {
