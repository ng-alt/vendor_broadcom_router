...
var StartChannel = new Array(<%4754%>);
var FinishChannel = new Array(<%4755%>);
...
var curr_region = "<%20%>"
var curr_channel_5g_value = "<%1869%>"
var curr_channel_2g_value = "<%1849%>"
...
function setOpMode_24g_psr()
{
    ...
    if ((sec_type_2G == "None") || (sec_type_2G == "WPA2-PSK")|| (sec_type_2G == "WPA-AUTO-PSK"))
    {
        ...
        cf.opmode.options[0].text = "<%4760%>";
        cf.opmode.options[1].text = "<%4761%>";
